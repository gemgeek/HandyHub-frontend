      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-800 text-white p-6 md:flex flex-col hidden">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="font-semibold text-lg">Hello, {user?.firstName}!</span>
          </div>
          <div className="space-y-4">
            ...
            <Link to="/dashboard/artisan/services" onClick={handleLinkClick} className="flex items-center space-x-2 p-2 rounded hover:bg-gray-700 transition-colors"><span>My Services</span></Link>
            <Link to="/dashboard/artisan/reviews" onClick={handleLinkClick} className="flex items-center space-x-2 p-2 rounded hover:bg-gray-700 transition-colors"><span>My Reviews</span></Link>
          </div>
        </aside>
