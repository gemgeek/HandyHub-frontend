      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-800 text-white p-6 md:flex flex-col hidden">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="font-semibold text-lg">Hello, Matilda</span>
          </div>
          <div className="space-y-4">
            <Link to="/dashboard/customer" className="flex items-center space-x-2 p-2 rounded hover:bg-gray-700 transition-colors">
              {/* SVG icons */}
              <span>Dashboard</span>
            </Link>
            <Link to="/dashboard/customer/profile" className="flex items-center space-x-2 p-2 rounded hover:bg-gray-700 transition-colors">
              {/* SVG icons */}
              <span>My Profile</span>
            </Link>
            <Link to="/dashboard/customer/bookings" className="flex items-center space-x-2 p-2 rounded hover:bg-gray-700 transition-colors">
              {/* SVG icons */}
              <span>My Bookings</span>
            </Link>
            <Link to="/dashboard/customer/favorites" className="flex items-center space-x-2 p-2 rounded hover:bg-gray-700 transition-colors">
              {/* SVG icons */}
